...
<nav class="menu_hover">
  <div class="bleft">
      <div class="menu__item_hover">
        ...
        <img class="menu__item-img_hover" src="@asset('images/moi_2.jpg')" alt="Some image"/>
      ...
      <div class="menu__item_hover">
        <a class="menu__item-link_hover" href="{{get_permalink( get_page_by_path( 'realisation' ))}}">Realisations</a>
        <img class="menu__item-img_hover" src="@asset('images/couleur_violet.gif')" alt="Some image"/>
        <div class="marquee_hover">
          <div class="marquee__inner_hover" aria-hidden="true">
